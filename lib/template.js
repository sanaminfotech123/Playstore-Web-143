...
export function buildStandaloneHtml(app = {}) {
	...
	const defaultLogo = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200'><defs><linearGradient id='bg' x1='0' y1='0' x2='1' y2='1'><stop offset='0%25' stop-color='%230a2540'/><stop offset='50%25' stop-color='%230052cc'/><stop offset='100%25' stop-color='%230065ff'/></linearGradient><linearGradient id='gold' x1='0' y1='0' x2='1' y2='0'><stop offset='0%25' stop-color='%23f6d365'/><stop offset='100%25' stop-color='%23fda085'/></linearGradient></defs><rect width='200' height='200' rx='46' fill='url(%23bg)'/><path d='M100 45 L155 75 L45 75 Z' fill='url(%23gold)'/><rect x='52' y='82' width='16' height='56' rx='4' fill='%23ffffff'/><rect x='84' y='82' width='16' height='56' rx='4' fill='%23ffffff'/><rect x='116' y='82' width='16' height='56' rx='4' fill='%23ffffff'/><rect x='148' y='82' width='16' height='56' rx='4' fill='%23ffffff'/><rect x='42' y='144' width='132' height='16' rx='4' fill='url(%23gold)'/><circle cx='145' cy='145' r='22' fill='%2300d4b6'/><path d='M135 145 L142 152 L156 138' stroke='%23ffffff' stroke-width='4' stroke-linecap='round' stroke-linejoin='round' fill='none'/></svg>";
	const logoUrl = app.logoUrl ? String(app.logoUrl).replace(/"/g, '&quot;') : defaultLogo;
...
<body>
    ...
    <main id="top" class="page-shell">
        ...
        <section class="app-hero">
            <div class="app-logo">
                <img id="appLogo" src="${logoUrl}" alt="${name} Logo" onerror="this.onerror=null;this.src='${defaultLogo}';" />
            </div>
